...
class ParserClass {
     ...
     */
    constructor(url, shopsAnother) {let shops = shopsAnother || shopsConfig;
     ...
     */
    approveFromUrl() {
        return utils.validUrl(this.url) &&
            utils.getHost(this.url) === utils.getHost(normalizeUrl(this.shopkey));
    }
